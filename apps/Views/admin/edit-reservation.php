    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <header class="admin-topbar">
                <h1 class="admin-greeting">Update Reservation #<?= htmlspecialchars($reservationID ?? '') ?></h1>
            ...
            <div class="reservation-form" style="padding: 20px 0;">
                <div class="container d-flex flex-column justify-center align-center gap-40">
                    ...
                    <!--Reservation Form-->
                    <form action="<?php echo htmlspecialchars('index.php?url=admin/reservations/edit&id=' . ($reservationID ?? '')); ?>" method="POST" class="reservation-form-container d-flex flex-column gap-40">
                        ...
                        <div class="button-row d-flex gap-20">
                            ...
                            <button type="button" onclick="location.href='index.php?url=admin/reservations'" class="btn-reservation-reset-btn">Go Back</button>
                        </div>
                    </form>
